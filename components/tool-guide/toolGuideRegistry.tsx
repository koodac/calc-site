    ...
    <>
      ...
      <GuideFaq
        items={[
          ...
          { q: "출산전후휴가 급여는 전액 고용보험에서 지급되나요?", a: "우선지원대상기업(중소기업)은 90일 전액 고용보험 지원, 대기업은 처음 60일은 회사 부담, 나머지 30일만 고용보험에서 지원합니다. 지급 상한은 월 210만 원(2026년 기준)입니다." },
        ]}
      />
    </>
  );
    ...
    <>
      ...
      <GuideTable
        ...
        rows={[
          ...
          ["증권거래세 (코스피 매도)", "0.18% (2026년 기준)"],
          ["증권거래세 (코스닥 매도)", "0.18% (2026년 기준)"],
          ["양도소득세", "대주주 해당 시 적용"],
        ]}
      />
      <GuideH2>자주 묻는 질문 (FAQ)</GuideH2>
...
function AcquisitionTaxGuide() {
  return (
    <>
      ...
      />
      <GuideP>
        조정대상지역 2주택은 8%, 3주택 이상은 12% 중과세율이 적용됩니다(2026년 기준).
