    ...
    <>
      ...
      <GuideTable
        ...
        rows={[
          ...
          ["건강보험", "3.545%", "장기요양보험 별도 (건보료 × 12.95%)"],
          ["고용보험", "0.9%", "실업급여 기준"],
  ...
  return (
    <>
      ...
      <GuideP>
        ...
        → 1일 평균임금 = (900+150) ÷ 92 ≈ 11,413원{"\n"}
        → 퇴직금 = 11,413 × 30 × (1,095÷365) ≈ <strong>약 102.7만 원</strong>
      </GuideP>
    ...
    <>
      ...
      <GuideFaq
        items={[
          ...
          {
            q: "입사 첫 해에도 연차가 생기나요?",
            a: "네. 1년 미만 근로자도 매월 개근하면 1일씩 최대 11일의 유급휴가가 발생합니다. 1년이 되는 시점에 15일이 추가 발생하되, 첫 해 사용한 월차는 15일에서 차감될 수 있습니다.",
          },
          {
  ...
  return (
    <>
      ...
      <GuideTable
        ...
        rows={[
          ["주 15시간", "10,030원", "(15 ÷ 40) × 8 × 10,030", "30,090원"],
          ["주 20시간", "10,030원", "(20 ÷ 40) × 8 × 10,030", "40,120원"],
          ["주 30시간", "12,000원", "(30 ÷ 40) × 8 × 12,000", "72,000원"],
          ["주 40시간 (풀타임)", "10,030원", "8 × 10,030", "80,240원"],
        ]}
      />
      <GuideP className="text-neutral-500">※ 2025년 최저시급 10,030원 기준. 2026년 최저시급은 고용노동부 공시 확인 필요.</GuideP>
    ...
    <>
      ...
      <GuideTable
        ...
        rows={[
          ...
          ["장기요양보험", "건강보험료 × 12.95%", "동일", "건강보험료 × 25.9%"],
          ["고용보험", "0.9%", "0.9%~(규모별 추가)", "-"],
      ...
      <GuideTable
        ...
        rows={[
          ["200만 원", "90,000원", "70,900원", "9,181원", "18,000원", "약 188,081원"],
          ["300만 원", "135,000원", "106,350원", "13,772원", "27,000원", "약 282,122원"],
          ["400만 원", "180,000원", "141,800원", "18,363원", "36,000원", "약 376,163원"],
          ["500만 원", "225,000원", "177,250원", "22,954원", "45,000원", "약 470,204원"],
          ["700만 원", "315,000원", "248,150원", "32,136원", "63,000원", "약 658,286원"],
        ]}
      />
      ...
      <GuideBulletList
        items={[
          "국민연금 상한액: 보수월액 617만 원 초과분은 과세 제외 (2024년 기준)",
  ...
  return (
    <>
      ...
      <GuideTable
        ...
        rows={[
          ["1개월", "통상임금 100% (상한 200만원)", "통상임금 80% (상한 150만원)"],
          ["2개월", "통상임금 100% (상한 250만원)", "통상임금 80% (상한 150만원)"],
          ["3개월", "통상임금 100% (상한 300만원)", "통상임금 80% (상한 150만원)"],
          ["4개월", "통상임금 100% (상한 350만원)", "통상임금 50% (상한 120만원)"],
          ["5개월", "통상임금 100% (상한 400만원)", "통상임금 50% (상한 120만원)"],
          ["6개월", "통상임금 100% (상한 450만원)", "통상임금 50% (상한 120만원)"],
          ["7~12개월", "통상임금 50% (상한 120만원)", "통상임금 50% (상한 120만원)"],
        ]}
      />
      <GuideBulletList
        items={[
...
function PartTimeGuide() {
  return (
    <>
      ...
      <GuideH2>주 근무시간별 월 예상 급여 참고표 (시급 10,030원 기준)</GuideH2>
      <GuideTable
        headers={["주 근무시간", "주휴수당", "월 예상 급여 (주휴 포함)", "월 최저 기준"]}
        rows={[
          ["주 10시간 (주 15h 미만)", "없음", "약 435,305원", "최저임금 이상"],
          ["주 15시간", "약 30,090원", "약 783,343원", "최저임금 이상"],
          ["주 20시간", "약 40,120원", "약 1,044,124원", "최저임금 이상"],
          ["주 30시간", "약 60,180원", "약 1,566,187원", "최저임금 이상"],
          ["주 40시간 (풀타임)", "약 80,240원", "약 2,096,270원", "월 최저임금 충족"],
        ]}
      />
      <GuideP className="text-neutral-500">※ 2025년 최저시급 10,030원 기준. 실제 급여는 계약 조건에 따라 다를 수 있습니다.</GuideP>
    ...
    <>
      ...
      <GuideBulletList
        items={[
          ...
          "연금저축·IRP 납입 시 연 최대 700만원까지 세액공제 (공제율 13.2~16.5%)",
...
function IncomeTaxGuide() {
  return (
    <>
      ...
      <GuideBulletList
        items={[
          "연금저축·IRP: 연 700만원 한도 세액공제 (공제율 13.2~16.5%)",
...
function MinWageGuide() {
  return (
    <>
      ...
      />
      <GuideP className="text-neutral-500">※ 2026년 최저시급은 고용노동부 공시 자료를 확인하세요.</GuideP>
      ...
      <GuideBulletList
        items={[
          ...
          "상여금: 연 환산 최저임금의 25% 초과분만 산입 가능 (2024년 이후)",
    ...
    <>
      ...
      <GuideFaq
        items={[
          ...
          { q: "출산전후휴가 급여는 전액 고용보험에서 지급되나요?", a: "우선지원대상기업(중소기업)은 90일 전액 고용보험 지원, 대기업은 처음 60일은 회사 부담, 나머지 30일만 고용보험에서 지원합니다. 지급 상한은 월 210만 원(2024년 기준)입니다." },
        ]}
      />
    </>
  );
    ...
    <>
      ...
      <GuideFaq
        items={[
          ...
          { q: "공인중개사 수수료는 어떻게 계산하나요?", a: "2021년 개정 기준으로 매매 6억 미만 0.4%, 6억~9억 0.4~0.5%, 9억 이상 0.9% 이내에서 협의합니다. 전·월세는 별도 요율이 적용됩니다. 최종 수수료는 반드시 협의 후 영수증을 받으세요." },
        ]}
      />
    </>
  );
...
function CommissionGuide() {
  return (
    <>
      ...
      <GuideFaq
        items={[
          { q: "수수료 무료 이벤트라도 세금은 내야 하나요?", a: "네, 증권거래세는 매도 시 자동으로 부과되며 수수료 면제와 관계없이 납부해야 합니다. 0.18%(코스피·코스닥)는 정부세로 증권사가 대납 후 청구합니다." },
          ...
          { q: "빈번한 매매(데이트레이딩)에서 수수료가 수익에 미치는 영향은?", a: "수수료 0.015% + 세금 0.18%로 매도 시마다 0.195%가 차감됩니다. 하루 10번 거래하면 연간 수백 %의 수수료가 발생합니다. 빈번한 매매는 수수료·세금 부담을 먼저 고려해야 실질 수익을 계산할 수 있습니다." },
        ]}
      />
    </>
  );
    ...
    <>
      ...
      <GuideFaq
        items={[
          ...
          { q: "전기차 충전 비용은 어떻게 계산하나요?", a: "배터리 용량(kWh) × 충전 단가(원/kWh) = 충전 비용. 공공 완속 충전기(7kW) 단가는 약 255~310원/kWh, 급속(50kW)은 약 390~430원/kWh입니다(2024년 기준). 완충 시 아이오닉6(77kWh) 기준 약 2만~3만 3천 원 수준입니다." },
        ]}
      />
    </>
  );
...
function ElectricityGuide() {
  return (
    <>
      ...
      <GuideH2>주택용 저압 누진 요금 (2024년 기준)</GuideH2>
      <GuideTable
  ...
  return (
    <>
      ...
      <GuideFormulaBox>
        ...
        예: 2024년 4번째 입영 → (2024−1949)×6 + 4 = 75×6+4 = 454기 (근사치)
      </GuideFormulaBox>
      <GuideBulletList
        items={[
...
function DischargeGuide() {
  return (
    <>
      ...
      <GuideH3>복무 형태별 의무 복무 기간 (2024년 기준)</GuideH3>
      <GuideTable
      ...
      <GuideFormulaBox>
        전역일 = 입대일 + 복무 기간{"\n"}
        남은 일수 = 전역일 − 오늘{"\n\n"}
        예: 2024-03-04 육군 입대 → 18개월 뒤 = 2025-09-04 전역
      </GuideFormulaBox>
      <GuideBulletList
        items={[
...
function SeveranceTaxGuide() {
  return (
    <>
      ...
      <GuideH3>근속연수공제 (2024년 기준)</GuideH3>
      <GuideTable
        headers={["근속연수", "공제액"]}
        rows={[
          ["5년 이하", "30만원 × 근속연수"],
...
function SalaryReverseGuide() {
  return (
    <>
      ...
      <GuideFormulaBox>
        실수령 ≈ 월급 − 국민연금(4.5%) − 건강보험(3.545%) − 장기요양(건강보험료×12.95%) − 고용보험(0.9%) − 소득세·지방소득세
      </GuideFormulaBox>
...
function LocalHealthInsuranceGuide() {
  return (
    <>
      ...
      <GuideH3>보험료 산정 구조 (2024년 기준)</GuideH3>
      <GuideTable
        headers={["항목", "계산 방법"]}
        rows={[
...
function GlobalIncomeTaxGuide() {
  return (
    <>
      ...
      <GuideH3>종합소득세율 (2024년 기준)</GuideH3>
      <GuideTable
        headers={["과세표준", "세율", "누진공제액"]}
        rows={[
          ["1,400만원 이하", "6%", "−"],
...
function AcquisitionTaxGuide() {
  return (
    <>
      ...
      />
      <GuideP>
        조정대상지역 2주택은 8%, 3주택 이상은 12% 중과세율이 적용됩니다(2024년 기준).
        ...
        items={[
          {
            ...
            a: "생애최초 주택 구입자는 취득세 200만원 한도 내에서 감면 혜택이 있습니다(2024년 기준). 소득·주택가액 요건을 충족해야 합니다.",
          },
          {
            q: "취득세는 언제 납부해야 하나요?",
...
function JeonseLoanInterestGuide() {
  return (
    <>
      ...
      <GuideH3>주요 전세대출 종류 (2024년 기준)</GuideH3>
      <GuideTable
...
function RentTaxCreditGuide() {
  return (
    <>
      ...
      <GuideH3>월세 세액공제 조건 및 공제율 (2024년 기준)</GuideH3>
      <GuideTable
