  ...
  return (
    <>
      ...
      <GuideTable
        ...
        rows={[
          ["200만 원", "95,000원", "70,900원", "9,316원", "18,000원", "약 193,216원"],
          ["300만 원", "142,500원", "106,350원", "13,974원", "27,000원", "약 289,824원"],
          ["400만 원", "190,000원", "141,800원", "18,633원", "36,000원", "약 386,433원"],
          ["500만 원", "237,500원", "177,250원", "23,291원", "45,000원", "약 483,041원"],
          ["700만 원", "302,570원(상한)", "248,150원", "32,607원", "63,000원", "약 646,327원"],
        ]}
      />
...
function SalaryReverseGuide() {
  return (
    <>
      ...
      <GuideFormulaBox>
        실수령 ≈ 월급 − 국민연금(4.75%) − 건강보험(3.545%) − 장기요양(건강보험료×13.14%) − 고용보험(0.9%) − 소득세·지방소득세
      </GuideFormulaBox>
